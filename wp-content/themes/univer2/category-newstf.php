...
<h4><i class="fa fa-map-o terrakote"></i> 
					<span class="head-h"> Новости ОВФО</span></h4>
    ...
    <div class="row">
        <div class="col-md-8">
            <?php
            $args=array(
                'category__in' => 19, //из какой категории вывести (удалите эту строку, если хотите, чтобы показовало последние материалы из всех рубрик сразу)
'showposts'=>1000, //сколько показать статей
