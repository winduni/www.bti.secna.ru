    ...
    <header id="this-is-top">
        <div class="container-fluid">
            ...
            <div class="topmenu row hidden-xs">
                <nav class="col-sm-offset-3 col-md-offset-4 col-lg-offset-4 col-sm-4 col-md-4 col-lg-4 hidden-xs">
            ...
            <div class="row header">
                <div class="col-sm-4 col-md-4 col-lg-4 head-lg" style="padding-bottom:10px;">
                    <a href="<?php echo home_url();?>"><img src="<?php bloginfo('template_url'); ?>/img/logotip.png" align=left style="padding-right:10px;width:65px;"></a> <h4 style="margin-bottom:0px;">Бийский <br>технологический <br>институт</h4> <small>(филиал) ФГБОУ ВО
                        «Алтайский государственный технический университет им. И.И. Ползунова»</small>
                </div>
                ...
                <div class="col-sm-8 col-md-8 col-lg-8 head-lg">
                    <div class="text-right header-padding">
                        ...
                        <div class="h-block" style="padding:3px 15px 10px 15px;">
            ...
            <nav class="main-menu navbar-main-slide">
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="http://old.bti.secna.ru/education/umo/oop.shtml">Основные образовательные программы</a>
                            </li>
                            ...
                            <li><a href="http://old.bti.secna.ru/education/ualmumd/ualmumd.shtml">Учебно-организационная деятельность</a></li>
                            <li><a href="http://old.bti.secna.ru/sveden/umd.shtml">Методическая деятельность</a></li>
                            <li><a href="<?php echo home_url();?>/nauchno-metodicheskij-sovet/">Научно-методический совет</a></li>
                            <li><a href="http://old.bti.secna.ru/eios/">ЭИОС</a></li>
                            ...
                            <li> <a href="#">Личный кабинет преподавателя</a></li>
                            <li><a href="http://db.biysk.secna.ru/graduate/postgrad.form_login">Личный кабинет аспиранта </a></li>
                            <li><a href="<?php echo home_url();?>/students/rasp/">Расписание занятий| сессии | аттестационных испытаний</a></li>
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="http://old.bti.secna.ru/nauka/nir.shtml">Научно-исследовательская деятельность</a></li>
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="https://student.altstu.ru/login/"> Личный кабинет студента</a> </li>
                            <li><a href="http://db.biysk.secna.ru/graduate/postgrad.form_login">Личный кабинет аспиранта</a></li>
                            <li><a href="http://old.bti.secna.ru/eios/"> Электронные ресурсы ЭБС</a></li>
                            ...
                            <li><a href="http://old.bti.secna.ru/students/students/diplom.shtml"> Дипломирование</a></li>
                            <li><a href="http://old.bti.secna.ru/students/stud.shtml"> Внеучебная и воспитательная деятельность</a></li>
                            ...
                            <li><a href="http://old.bti.secna.ru/education/kafedr/bdikfo.shtml"> Информация студентам-заочникам</a></li>
                        </ul>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="http://old.bti.secna.ru/eios/"> Электронные ресурсы /ЭБС</a></li>
                            <li><a href="http://old.bti.secna.ru/education/umo/index.shtml#oop"> Учебная деятельность</a></li>
                            ...
                            <li><a href="http://old.bti.secna.ru/teacher/pov_kvalif.shtml"> Повышение квалификации</a></li>
                            <li><a href="http://old.bti.secna.ru/teacher/profkom"> Профсоюз</a></li>
            ...
            <nav class="main-menu-lg navbar-main-slide">
                ...
                <div class="single-nav nav2">
                    ...
                    <div class="descr d2">
                        <div class="col-md-5">
                            ...
                            <a href="http://old.bti.secna.ru/education/umo/oop.shtml">Основные образовательные программы</a>
                            ...
                            <br><a href="http://old.bti.secna.ru/education/ualmumd/ualmumd.shtml">Учебно-организационная деятельность</a>
                            <br><a href="http://old.bti.secna.ru/sveden/umd.shtml">Методическая деятельность</a>
                        ...
                        <div class="col-md-7">
                            ...
                            <a href="http://old.bti.secna.ru/eios/">ЭИОС</a>
                            <br><a href="https://student.altstu.ru/login/">Личный кабинет студента</a> | <a href="https://app.bti.secna.ru:8443/kab/emp.reg"> сотрудника </a> | <a href="#">преподавателя,</a> | <a href="http://db.biysk.secna.ru/graduate/postgrad.form_login">аспиранта </a>
                            <br><a href="<?php echo home_url();?>/students/rasp/">Расписание занятий| сессии | аттестационных испытаний</a>
                ...
                <div class="single-nav nav3">
                    ...
                    <div class="descr d3">
                        <div class="col-md-6">
                            ...
                            <a href="http://old.bti.secna.ru/nauka/nir.shtml">Научно-исследовательская деятельность</a>
                ...
                <div class="single-nav nav5">
                    ...
                    <div class="descr d5">
                        <div class="col-md-6">
                            ...
                            <a href="<?php echo home_url();?>/students/rasp/"> Расписание занятий/сессии/</a> &nbsp; <a href="http://old.bti.secna.ru/students/rasp_gai">аттестационных испытаний</a>
                            ...
                            <br><a href="http://old.bti.secna.ru/eios/"> Электронные ресурсы ЭБС</a>
                            ...
                            <br><a href="http://old.bti.secna.ru/students/students/diplom.shtml"> Дипломирование</a>
                        ...
                        <div class="col-md-6">
                            ...
                            <br><a href="http://old.bti.secna.ru/education/kafedr/bdikfo.shtml"> Информация студентам-заочникам</a>
                        </div>
                ...
                <div class="single-nav nav7">
                    ...
                    <div class="descr d7">
                        <div class="col-md-4">
                            <h5><i class="fa fa-files-o" aria-hidden="true"></i> ЭИОС  </h5>
                            <a href="http://old.bti.secna.ru/eios/"> Электронные ресурсы /ЭБС</a>
                            <br><a href="http://old.bti.secna.ru/education/umo/index.shtml#oop"> Учебная деятельность</a>
                        ...
                        <div class="col-md-4">
                            ...
                            <br><a href="http://old.bti.secna.ru/teacher/pov_kvalif.shtml"> Повышение квалификации</a>
                            <br><a href="http://old.bti.secna.ru/teacher/profkom"> Профсоюз</a>
